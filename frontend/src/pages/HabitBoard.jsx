...
export default function HabitBoard() {
  ...
  // Auto-miss is handled by the Azure Function (midnightAutoMiss) — removed from frontend to avoid race conditions
  ...
  async function handleConfirmCheckIn() {
    ...
    try {
      ...
      if (result?.alreadyCheckedIn) {
        // Backend blocked the write — but if the existing entry was a miss written
        // by the auto-miss function, habitService now overwrites it. This branch
        // means it was already completed:true, so we're fine.
        console.log('[checkIn] already completed today');
      }

      // Suggest adaptation if habit has many misses
      ...
      // Wait briefly for Cosmos DB to reflect the write before re-reading
